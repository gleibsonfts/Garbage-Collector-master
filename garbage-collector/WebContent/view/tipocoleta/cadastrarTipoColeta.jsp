...
<title>Cadastrar Tipo Coleta</title>
...
<body>
	...
	<h1 align="center" style="margin-top: 200px; margin-left: 200px;">Cadastro
		de Tipos de Coletas</h1>
		...
		<form class="form-horizontal" action="cadastrarTipoColeta"
			...
			<div class="col-4">
				<label for="exampleInputName" class="hora">Tipo da Coleta:</label> <input
					...
					placeholder="Plástico" style="width: 50%" maxlength="15"
					minlength="3"
					''
